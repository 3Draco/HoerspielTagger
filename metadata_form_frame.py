...
class MetadataFormFrame(ctk.CTkScrollableFrame):
    ...
    def __init__(self, parent, on_update_live_preview: Callable[[], None]):
        ...
        self.grid_columnconfigure(2, weight=1) # Column 2: LLM Proposal (Nachher)
    ...
    def _build_ui(self):
        ...
        ctk.CTkLabel(self, text="🤖 LLM-Vorschlag / Bearbeitbar (Nachher)", font=ctk.CTkFont(size=12, weight="bold"), text_color="#1f538d").grid(row=0, column=2, padx=10, pady=(5, 8), sticky="w")
